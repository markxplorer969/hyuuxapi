...
import { Check, X, Star, Users, Zap, Shield, Clock, ArrowRight, ChevronDown, ChevronUp, Headphones, MessageCircle, Rocket, Crown, Sparkles, Mail } from 'lucide-react';
...
const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    name: 'VIP',
    price: '$29',
    description: 'For power users, enterprises, and mission-critical applications',
    features: [
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Free: Community support via Discord. Premium: Email support within 24 hours. VIP: 24/7 dedicated support with phone and video calls.",
    category: "Support"
  }
];
