// Mock payment status for testing PAID
...
export async function GET(req: Request) {
  ...
  // Mock transaction data with PAID status
  const mockTrx = {
    merchant_ref: ref,
    ...
    qr_url: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https%3A%2F%2Fexample.com&format=png',
